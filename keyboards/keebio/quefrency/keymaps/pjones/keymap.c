...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F7,   KC_F8,   SFT_LCK, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,            KC_PSCR, \
  ...
  [L_RAISE] = LAYOUT_65_with_macro(
    ...
    RGB_HUI, RGB_HUD, _______, _______, _______, _______, _______, _______, _______, _______, PJ_LT,   PJ_GT,   KC_BSLS, _______,          KC_PGUP,          _______, \
