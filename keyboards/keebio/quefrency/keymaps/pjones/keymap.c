...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_BASE] = LAYOUT_65_with_macro(
    KC_F1,   KC_F2,   QK_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  NO_KEY,  KC_BSPC, KC_MPLY, \
  ...
  [L_RAISE] = LAYOUT_65_with_macro(
    ...
    RGB_HUI, RGB_HUD, _______, QK_BOOT, _______, _______, _______, KC_MINS, KC_PLUS, _______, _______, _______, KC_BSLS, _______,          KC_PGUP,          _______, \
